...
/*
    -- Clean up mess if previous test failed; need to find and set the file id first
    DECLARE @T2_project nvarchar(16) = 'p1__',
            @T2_mfgr nvarchar(16) = 'Telonics',
            @T2_collar1 nvarchar(16) = 'c1__',
            @T2_collar2 nvarchar(16) = 'c2__',
            @T2_file nvarchar(16) = 'f1__',
            @T2_fileId int
    SELECT @T2_fileId = fileid from collarfiles where filename = @T2_file
    EXEC [dbo].[CollarFile_Delete] @T2_fileId
    DELETE CollarDeployments Where [ProjectId] = @T2_project 
    DELETE Collars where CollarManufacturer = @T2_mfgr and CollarId IN (@T2_collar1, @T2_collar2)
...
*/
	...
	SELECT @T2_deploy1 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11 12:00'
    --Test
    SET @T2_msg = ''
    ...
    EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy1, '2012-05-11 12:00', NULL
    ...
    PRINT @T2_msg
    --Reset
    EXEC [dbo].[CollarDeployment_Delete] @T2_deploy1
    ...
    EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy1, '2012-05-11 12:00', '2012-05-14 12:00'
    ...
    EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy1, '2012-05-11 12:00', '2012-05-15 12:00'
    ...
    EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy1, '2012-05-11 12:00', '2012-05-13 12:00'
    ...
    PRINT '  Check locations after legal changes to deployment retrieval date; using animal with mortality date'
	...
	SELECT @T2_deploy1 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal2 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11 12:00'
    --Test
    SET @T2_msg = ''
	...
	SELECT @T2_deploy1 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11'
    BEGIN TRY
        EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy1, '2012-05-11', '2012-05-11'
        SET @T2_msg = 'Failed'
    END TRY
    BEGIN CATCH
        SET @T2_msg = 'Passed'
	...
	SELECT @T2_deploy1 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11'
    BEGIN TRY
        EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy1, '2012-05-11', '2012-05-10'
        SET @T2_msg = 'Failed'
    END TRY
    BEGIN CATCH
        SET @T2_msg = 'Passed'
	...
	SELECT @T2_deploy1 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-13'
    ...
    --Reset
    EXEC [dbo].[CollarDeployment_Delete] @T2_deploy1
    EXEC [dbo].[CollarDeployment_Delete] @T2_deploy2
    ...
    EXEC [dbo].[CollarDeployment_Insert] @T2_project, @T2_animal1, @T2_mfgr, @T2_collar1, '2012-05-11', '2012-05-12'
 	SELECT @T2_deploy2 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11'
   BEGIN TRY
        EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy2, '2012-05-11', '2012-05-14'
        SET @T2_msg = 'Failed'
    END TRY
    BEGIN CATCH
        SET @T2_msg = 'Passed'
	...
	SELECT @T2_deploy2 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11'
    BEGIN TRY
        EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy2, '2012-05-11', '2012-05-16'
        SET @T2_msg = 'Failed'
    END TRY
    BEGIN CATCH
        SET @T2_msg = 'Passed'
	...
	SELECT @T2_deploy2 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11'
    BEGIN TRY
        EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy2, '2012-05-11', NULL
        SET @T2_msg = 'Failed'
    END TRY
    BEGIN CATCH
        SET @T2_msg = 'Passed'
	...
	SELECT @T2_deploy1 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar2 AND DeploymentDate = '2012-05-13'
    EXEC [dbo].[CollarDeployment_Insert] @T2_project, @T2_animal1, @T2_mfgr, @T2_collar1, '2012-05-11', '2012-05-12'
	SELECT @T2_deploy2 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11'
    BEGIN TRY
        EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy2, '2012-05-11', '2012-05-13'
	...
	SELECT @T2_deploy1 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal2 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-13'
    EXEC [dbo].[CollarDeployment_Insert] @T2_project, @T2_animal1, @T2_mfgr, @T2_collar1, '2012-05-11', '2012-05-12'
	SELECT @T2_deploy2 = DeploymentId FROM CollarDeployments WHERE ProjectId = @T2_project and AnimalId = @T2_animal1 AND CollarManufacturer = @T2_mfgr AND CollarId = @T2_collar1 AND DeploymentDate = '2012-05-11'
    BEGIN TRY
        EXEC [dbo].[CollarDeployment_UpdateDates] @T2_deploy2, '2012-05-11', '2012-05-13'
...
/*
    -- Clean up mess if previous test failed; need to find and set the file id first
    DECLARE @T7_mfgr nvarchar(16) = '__test__'
    DELETE Collars where CollarManufacturer = @T7_mfgr
    DELETE LookupCollarManufacturers WHERE CollarManufacturer = @T7_mfgr
*/

    --Check to make sure we are not going to overwrite any data
    IF EXISTS (SELECT 1 from LookupCollarManufacturers Where CollarManufacturer = @T7_mfgr)
    BEGIN
        PRINT '  Aborting tests.  Existing data conflicts with test data.'
        RETURN
    END
    ...
    -- Add the sa is a project investigator
    IF NOT EXISTS(SELECT 1 FROM [dbo].[ProjectInvestigators] WHERE [Login] = @T7_sa)
    BEGIN
        INSERT [dbo].[ProjectInvestigators] ([Login],[Name],[Email],[Phone]) VALUES (@T7_sa,@T7_sa,@T7_sa,@T7_sa)
    END
    ...
    -- Test1a
    SET @T7_test = '  Test1a: Insert collar null argos, null dispdate (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_1a', @T7_model, @ArgosId = NULL, @DisposalDate = NULL 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    END CATCH
    --Report
    PRINT @T7_msg

    -- Test2a
    SET @T7_test = '  Test2a: Insert collar non-null argos, null dispdate (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_2a', @T7_model, @ArgosId = '2a', @DisposalDate = NULL 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test2b
    SET @T7_test = '  Test2b: Insert collar non-null argos, null dispdate - no argos conflict (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_2b', @T7_model, @ArgosId = '2b', @DisposalDate = NULL 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test2c
    SET @T7_test = '  Test2c: Insert collar non-null argos, null dispdate - argos conflict (bad): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_2c', @T7_model, NULL, '2b', NULL, NULL, NULL, NULL, NULL 
        SET @T7_msg = '  Fail' + @T7_test + 'Insert succeeded'
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Pass' + @T7_test
    END CATCH
    ...
    -- Test3a
    SET @T7_test = '  Test3a: Insert collar null argos, non-null dispdate (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_3a', @T7_model, @ArgosId = NULL, @DisposalDate = '2012-02-03' 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test3b
    SET @T7_test = '  Test3b: Insert collar null argos, non-null dispdate - no date conflict (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_3b', @T7_model, @ArgosId = NULL, @DisposalDate = '2012-02-04' 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test3c
    SET @T7_test = '  Test3c: Insert collar null argos, non-null dispdate - date conflict (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_3c', @T7_model, @ArgosId = NULL, @DisposalDate = '2012-02-04' 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test4a
    SET @T7_test = '  Test4a: Insert collar non-null argos, non-null dispdate (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_4a', @T7_model, @ArgosId = '4a', @DisposalDate = '2012-02-03' 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test4b
    SET @T7_test = '  Test4b: Insert collar non-null argos, non-null dispdate - no conflict (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_4b', @T7_model, @ArgosId = '4b', @DisposalDate = '2012-02-04' 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test4c
    SET @T7_test = '  Test4c: Insert collar non-null argos, non-null dispdate - argos conflict (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_4c', @T7_model, @ArgosId = '4b', @DisposalDate = '2012-02-05' 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test4d
    SET @T7_test = '  Test4d: Insert collar non-null argos, non-null dispdate - date conflict (ok): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_4d', @T7_model, @ArgosId = '4d', @DisposalDate = '2012-02-05' 
        SET @T7_msg = '  Pass' + @T7_test
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Fail' + @T7_test + ERROR_MESSAGE()
    ...
    -- Test4e
    SET @T7_test = '  Test4e: Insert collar non-null argos, non-null dispdate - both conflict (bad): '
    --Action/Test
    BEGIN TRY
		EXEC [dbo].[Collar_Insert] @T7_mfgr, 'c_4e', @T7_model, NULL, '4d', NULL, NULL, NULL, NULL, '2012-02-05' 
        SET @T7_msg = '  Fail' + @T7_test + 'Insert succeeded'
    END TRY
    BEGIN CATCH
        SET @T7_msg = '  Pass' + @T7_test
    ...
    -- Remove the sa from project investigator
    DELETE [dbo].[ProjectInvestigators] WHERE  [Login] = @T7_sa
