...
INSERT [dbo].[LookupCollarFileFormats] ([Code], [CollarManufacturer], [Name], [Description], [TableName], [HasCollarIdColumn]) VALUES (N'E', N'Telonics', N'Argos Email with Telonics Messages', N'Data from the Argos Email Service with encoded Telonics Gen3 or Gen4 messages', N'varies', N'N')
INSERT [dbo].[LookupCollarFileFormats] ([Code], [CollarManufacturer], [Name], [Description], [TableName], [HasCollarIdColumn]) VALUES (N'F', N'Telonics', N'Argos WebsService Download (*.aws) with Telonics Messages', N'Data from the Argos Web Service in CSV format with encoded Telonics Gen3 or Gen4 messages', N'varies', N'N')
