...
INSERT [dbo].[LookupCollarFileFormats] ([Code], [CollarManufacturer], [Name], [Description], [ArgosData]) VALUES (N'F', N'Telonics', N'Argos WebsService Download (*.aws) with Telonics Messages', N'Data from the Argos Web Service in CSV format with encoded Telonics Gen3 or Gen4 messages', N'Y')
...
INSERT [dbo].[LookupCollarFileFormats] ([Code], [CollarManufacturer], [Name], [Description], [ArgosData]) VALUES (N'H', N'Telonics', N'Telonics Gen4 Store-On-Board datalog file', N'This is the datalog file stored on the Gen4 collars.  It contains the collar parameters, and can be batch processed with TDC to create a format ''C'' file', N'N')
