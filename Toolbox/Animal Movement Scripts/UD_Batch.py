...
#
# Scripting Syntax:
# UD_Batch_AnimalMovement (Location_Layer, Subset_Identifier, hRef_Method, Fixed_hRef, hRef_Modifier, hRef_Proportion, hRef_To_Use, Save_Rasters_, Raster_Folder, Isopleths, Isopleth_Lines, Isopleth_Polygons, Isopleth_Donuts, Output_Projection)
#
# Example1:
# Scripting Example
