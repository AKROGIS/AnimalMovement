...
if __name__ == "__main__":
    ...
    isoplethInput = arcpy.GetParameterAsText(4)
    isoplethLines = arcpy.GetParameterAsText(5)
    isoplethPolys = arcpy.GetParameterAsText(6)
    isoplethDonuts = arcpy.GetParameterAsText(7)
    #scaleToUnitVariance = arcpy.GetParameterAsText(8)
...
#
    ...
    gotRaster, raster = GetUDRaster(locationLayer, "", h)
